package renderLevel
{
	...
	public class BoneKeyControl extends EventDispatcher
	{
		private static var instance:BoneKeyControl;
		...
		public static function getInstance():BoneKeyControl
		{
			if(!instance)
			{
				instance = new BoneKeyControl();
			}
			return instance;
		}
		...
		public function BoneKeyControl()
		{
