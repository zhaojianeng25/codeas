package renderLevel
{
	...
	public class Display3DMovieLocal extends Display3DBindMovie
	{
		...
		public var tittleHeight:Number=0
		public var hitBoxPoint:Point=new Point(10,10)
		...
		public function addPrototype():void{
			...
			bitmapdata = new BitmapData(128,128,true,0xffffffff);
		...
		public function setLineVc(meshData:MeshData):void{
			...
			for(var i:int = 0;i<boneIDary.length;i++){ 
				...
				var baseM:Matrix3D=Matrix3D(ary[boneIDary[i]].matrix).clone()
