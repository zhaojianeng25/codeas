package tempest.utils
{
	...
	public final class SpeedTester
	{
		...
		public static function testTick(label:String=""):void
		{
			if (t == -1)
				return;
			var result:int=getTimer();
			t=result;
			result-=t;
			trace("测试[" + label + "]结果：" + result + "ms (" + (result / baseTime).toFixed(2) + ")")
		}
		...
		public static function showMemory(flag:String=""):void
		{
			trace(flag + "——" + System.totalMemory / 1048576 + "MB");
		}
	}
}
