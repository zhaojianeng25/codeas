package mvc.centen.piccenten
{
	...
	import mvc.centen.discenten.BmpLevel;
	import mvc.centen.discenten.InfoLevel;
	
	import vo.FileDataVo;
	import vo.FileInfoType;
	import vo.H5UIFileNode;
	
	public class PicCentenPanel extends BasePanel
	{
		...
		public function PicCentenPanel()
		{
			super();
		...
		public  function resetInfoArr():void
		{
			...
			_InfoLevel.setInfoItem(UiData.picItem);
			
		
			_bmpLevel.setBmpItem(UiData.picFileDataVo);
