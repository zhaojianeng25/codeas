package mvc.centen.discenten
{
	...
	public class DisCentenPanel extends BasePanel
	{
		...
		public  function resetInfoArr():void
		{
			...
			if(UiData.bmpitem&&UiData.bmpitem.length){
				
				var $FileDataVo:FileDataVo=UiData.bmpitem[0];
				UiData.bitMapData=$FileDataVo.bmp;
				_bmpLevel.setBmpItem($FileDataVo)
	
			}else{
				_bmpLevel.setBmpItem(null)
			}
