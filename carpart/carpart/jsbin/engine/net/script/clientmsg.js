...
var s2c_field_death_cooldown = (function () {
    ...
    s2c_field_death_cooldown.read = function (self, bytes) {
        ...
        self.type = this.input.readUint16();
        //死亡者名字
        self.deathname = this.input.readString();
        //杀人者名字
...
var s2c_world_boss_rank = (function () {
    function s2c_world_boss_rank() {
        this.optcode = 0;
        /**
         * 排名
         */
    ...
    /**
     从输入二进制流中读取结构体
     */
    s2c_world_boss_rank.read = function (self, bytes) {
        if (this.input == null)
            this.input = new ByteArray();
        this.input = bytes;
        //var parmLen:uint;
    ...
    s2c_world_boss_rank.param_count = 2;
    s2c_world_boss_rank.optname = "onWorld_boss_rank";
    return s2c_world_boss_rank;
})();
...
var s2c_kuafu_xianfu_match_wait = (function () {
    function s2c_kuafu_xianfu_match_wait() {
        this.optcode = 0;
    }
    /**
     从输入二进制流中读取结构体
     */
    s2c_kuafu_xianfu_match_wait.read = function (self, bytes) {
        if (this.input == null)
            this.input = new ByteArray();
        this.input = bytes;
        //var parmLen:uint;
    ...
    s2c_kuafu_xianfu_match_wait.param_count = 2;
    s2c_kuafu_xianfu_match_wait.optname = "onKuafu_xianfu_match_wait";
    return s2c_kuafu_xianfu_match_wait;
})();
...
var s2c_offline_reward_result = (function () {
    ...
    s2c_offline_reward_result.param_count = 2;
