...
var UiTweenScale = (function () {
    ...
    UiTweenScale.prototype.changeButSize = function ($ui) {
        ...
        TweenLite.to(this._uiTweenVo, 0.07, { scale: 1.2, onComplete: function () { _this.changeButScale(); } });
    };
    UiTweenScale.prototype.changeButScale = function () {
        var _this = this;
        this._uiTweenVo.scale = 1.2;
        TweenLite.to(this._uiTweenVo, 0.05, { scale: 1, onComplete: function () { _this.changeButEnd(); } });
    };
