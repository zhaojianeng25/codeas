...
var Ragdoll_html = (function (_super) {
    ...
    Ragdoll_html.prototype.createRagdoll = function (scale, position, world, angleA, angleB, twistAngle) {
        ...
        var $disLock = new CanonPrefabSprite(lowerLeftLeg);
        $disLock.addToWorld();
        var $disLock = new CanonPrefabSprite(lowerRightLeg);
        $disLock.addToWorld();
        // Upper legs
        ...
        var $disLock = new CanonPrefabSprite(upperLeftLeg);
        $disLock.addToWorld();
        var $disLock = new CanonPrefabSprite(upperRightLeg);
        $disLock.addToWorld();
        // Pelvis
        ...
        var $disLock = new CanonPrefabSprite(pelvis);
        $disLock.addToWorld();
        // Upper body
        ...
        var $disLock = new CanonPrefabSprite(upperBody);
        $disLock.addToWorld();
        // Head
        ...
        var $disLock = new CanonPrefabSprite(head);
        $disLock.addToWorld();
        // Upper arms
        ...
        var $disLock = new CanonPrefabSprite(upperLeftArm);
        $disLock.addToWorld();
        var $disLock = new CanonPrefabSprite(upperRightArm);
        $disLock.addToWorld();
        // lower arms
        ...
        var $disLock = new CanonPrefabSprite(lowerLeftArm);
        $disLock.addToWorld();
        var $disLock = new CanonPrefabSprite(lowerRightArm);
        $disLock.addToWorld();
        // Neck joint
