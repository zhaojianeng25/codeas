...
class SharedDef
	{
		...
		//  家族地图信息
		public static FACTION_MAP_ID			:number = 5001;
		public static FACTION_FUHUO_X			:number = 157;
		public static FACTION_FUHUO_Y			:number = 84;
		...
		public static BORN_X			:number = 138;	// 出生坐标x 
		public static BORN_Y			:number = 174;	// 出生坐标y
		...
		public static MAX_KUAFU_TYPE			:number = 4;
		// 合服协议带的类型
		...
		// 购买
		public static LOG_ITEM_OPER_TYPE_SHOP_BUY			:number = 101;	// 从商场购买获得
		...
		public static MAX_MONEY_CHANGE_TYPE			:number = 103;
		// 特殊包裹类型
		...
		public static MONEY_TYPE_FACTION			:number = 9;	// 帮派贡献
		public static MONEY_TYPE_HONOR			:number = 10;	// 荣誉
		public static MONEY_TYPE_DOUHUN			:number = 11;	// 斗魂
		...
		public static PLAYER_PASSIVE_SPELL_MAX_COUNT			:number = 50;	//  被动技能个数
		// 玩家能否做某事的flag偏移定义
		...
		public static UINT_FIELD_BOOS_CUR_SPELLID			:number = 131;	// 当前正在释放的蓄力技能id
		...
		public static UINT_INT_FIELD_PASSIVE_SPELL_END			:number = 184;	// 被动技能结束
		public static MAX_UNIT_FIELD			:number = 185;
		...
		public static MAX_UNIT_STRING_FIELD			:number = 7;
		// 游戏对象类型
		...
		public static PLAYER_EXPAND_INT_MAP_STATUS			:number = 435;	// 地图开启进度
		public static PLAYER_EXPAND_INT_GAG_END_TIME			:number = 436;	// 禁言结束时间
		public static PLAYER_EXPAND_INT_TO_MAP			:number = 437;	// 玩家要传送到的地图
		public static PLAYER_EXPAND_INT_TO_INSTANCE_ID			:number = 438;	// 玩家要传送到的地图实例ID
		public static PLAYER_EXPAND_INT_TO_POS_X			:number = 439;	// 玩家药传送到的坐标
		public static PLAYER_EXPAND_INT_TO_POS_Y			:number = 440;
		public static PLAYER_EXPAND_INT_TO_LINE_NO			:number = 441;	// 传送线号
		public static PLAYER_EXPAND_INT_DB_MAP			:number = 442;	// 玩家最后一次进入副本前的地图	
		public static PLAYER_EXPAND_INT_DB_POS_X			:number = 443;	// 玩家最后一次进入副本前的坐标
		public static PLAYER_EXPAND_INT_DB_POS_Y			:number = 444;
		public static PLAYER_EXPAND_INT_CLIENT_DATA			:number = 445;	// 远程存储
		// ////////////////////////////////////////////////////////////////////////
		// 应用服部分	
		public static PLAYER_APPD_INT_FIELD_FLAG			:number = 545;	// 玩家标志位
		public static PLAYER_APPD_INT_FIELD_FLAG_END			:number = 552;	// 结束下标
		public static PLAYER_APPD_INT_FIELD_DAILY_TIME			:number = 552;	// 每天在线时长（min）
		public static PLAYER_APPD_INT_FIELD_RESET_DALIY			:number = 553;	// 重置的时间点每小时一次
		public static PLAYER_APPD_INT_FIELD_RECHARGE_SUM			:number = 577;	// 累计充值总数
		public static PLAYER_APPD_INT_FIELD_LAST_RECHARGE_TIME			:number = 578;	// 最后一笔充值时间
		public static PLAYER_APPD_INT_FLELD_JHM_FLAGS			:number = 579;	// 激活码flags
		public static PLAYER_APPD_INT_FLELD_JHM_FLAGS_END			:number = 587;	// 激活码flags_end
		// 主背包扩展时间戳
		public static PLAYER_APPD_INT_FIELD_EXTENSION_END_TIME			:number = 588;	// 主包裹扩展结束时间戳
		public static PLAYER_APPD_INT_FIELD_EXTENSION_REMAIN_TIME			:number = 589;	// 主包裹扩展剩余多少时间
		public static PLAYER_INT_FIELD_BLOCK_COUNT			:number = 591;	// 屏蔽列表个数
		public static PLAYER_INT_FIELD_WORLD_BOSS_JOIN_ID			:number = 592;	// 最后一次参加的世界BOSS id
		public static PLAYER_INT_FIELD_WORLD_BOSS_JOIN_STATE			:number = 593;	// 0:最后一次参加的世界BOSS状态, 1:进入的线数,2:死亡次数,3:预留
		// 场景服扩展下标开始了
		public static PLAYER_SCENED_INT_FLAGS			:number = 594;	// 玩家场景服标志位
		//  只显示装备的主动技能
		public static PLAYER_INT_FIELD_SPELL_START			:number = 602;
		public static PLAYER_INT_FIELD_SPELL_END			:number = 614;
		// 重要技能的CD
		public static PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_START			:number = 614;
		public static PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_END			:number = 654;
		public static PLAYER_EXPAND_KILL_MONSTER			:number = 654;	// 杀怪数
		// 跨服
		public static PLAYER_APPD_INT_FIELD_KUAFU_WARID			:number = 655;	// 跨服场次id
		public static PLAYER_INT_FIELD_KUAFU_NUMBER			:number = 656;	// 0:玩家报名跨服时收到匹配信息中给的编号 1:跨服类型（值参照枚举：EKUAFU_TYPE）
		public static PLAYER_INT_FIELD_MAIN_QUEST_ID			:number = 657;	// 当前主线任务
		public static PLAYER_INT_FIELD_QUEST_CHAPTER			:number = 658;	// 任务章节奖励领取情况
		public static PLAYER_INT_FIELD_MOUNT_LEVEL			:number = 659;	// 4个bytes(0:当前坐骑阶数 1:当前坐骑星级,2:当前坐骑是否骑乘，3:当前幻化id)
		public static PLAYER_INT_FIELD_DIVINE_ID			:number = 660;	// 当前装备的神兵id
		public static PLAYER_INT_FIELD_PASSIVE_SPELL_START			:number = 661;	// 被动技能开始
		public static PLAYER_INT_FIELD_PASSIVE_SPELL_END			:number = 711;	// 被动技能个数
		public static PLAYER_INT_FIELD_VIRTUAL_CAMP			:number = 711;	// 虚拟阵营
		public static PLAYER_INT_FIELD_WORLD_3V3_SCORE			:number = 712;	// 跨服3v3积分
		public static PLAYER_INT_FIELD_WORLD_3V3_TOTAL_SCORE			:number = 713;	// 跨服3v3积分
		public static PLAYER_INT_FIELD_WORLD_3V3_TREND_INFO			:number = 714;	// 胜负走势
		public static PLAYER_INT_FIELD_DOUJIANTAI_RANK			:number = 715;	// 斗剑台排名
		public static PLAYER_INT_FIELD_DOUJIANTAI_REFRESH_TIME			:number = 716;	// 最后一次刷新对手时间戳
		public static PLAYER_INT_FIELD_ARREARS			:number = 717;	// 欠费
		public static PLAYER_INT_FIELD_DAILY_QUEST_FINISHED			:number = 719;	//  每日任务完成数
		public static PLAYER_INT_FIELD_BAG_SORT_TIME			:number = 720;	// 整理背包时间戳
		// 已开启功能的记录
		public static PLAYER_INT_FIELD_OPEN_MENU_INDEX			:number = 721;
		public static PLAYER_INT_FIELD_OPEN_MENU_START			:number = 722;
		public static PLAYER_INT_FIELD_OPEN_MENU_END			:number = 822;
		// 已购家族商店物品的记录
		public static PLAYER_INT_FIELD_BUYED_FACTION_SHOP			:number = 823;	// 已购家族商店物品开始
		public static PLAYER_INT_FIELD_BUYED_FACTION_SHOP_END			:number = 831;	// 已购家族商店物品结束
		// 记录强制引导ID 
		public static PLAYER_INT_FIELD_GUIDE_ID_LAST			:number = 832;	// 上次完成的引导
		public static PLAYER_INT_FIELD_GUIDE_ID_NOW			:number = 833;	// 当前进行中的引导
		// 修炼场相关
		public static PLAYER_INT_FIELD_CULTIVATION_LAST_PLUNDER_TIME			:number = 834;	// 上次挑战时间戳
		public static PLAYER_INT_FIELD_CULTIVATION_LAST_REFRESH_TIME			:number = 835;	// 上次刷新对手时间戳
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_EXP			:number = 836;	// 当日累计掠夺经验
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_CHEST			:number = 837;	// 当日累计掠夺宝箱数
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PURCHASE_COUNT			:number = 838;	// 当日购买次数
		public static PLAYER_INT_FIELD_CULTIVATION_LEFT_PLUNDER_COUNT			:number = 839;	// 当前剩余挑战次数
		public static PLAYER_INT_FIELD_CULTIVATION_PLUNDER_RECORD_INDEX			:number = 840;	// 修练场修炼记录下标
		public static PLAYER_INT_FIELD_CULTIVATION_TOTAL_BEEN_PLUNDER_COUNT			:number = 841;	// 本轮被掠夺成功次数
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_TOTAL_PLUNDER_COUNT			:number = 842;	// 本日总掠夺次数
		public static PLAYER_INT_FIELD_CULTIVATION_START_TIME			:number = 843;	// 修炼开始时间
		public static PLAYER_INT_FIELD_CULTIVATION_LOST_INFO			:number = 844;	// 修炼宝箱丢失信息
		// 登陆大礼相关
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_TOTAL_DAYS			:number = 845;	// 登陆总天数
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_START			:number = 846;	// 领取状态开始
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_END			:number = 848;	// 领取状态结束
		//  非强制引导ID
		public static PLAYER_INT_FIELD_OPTIONAL_GUIDE_START			:number = 849;	// 非强制引导开始
		public static PLAYER_INT_FIELD_OPTIONAL_GUIDE_END			:number = 909;	//  非强制引导结束
		public static PLAYER_INT_FILED_LEAVE_RISK_TIME			:number = 909;	// 离开冒险世界的时间戳
		public static PLAYER_INT_FILED_LEAVE_RISK_PICKED			:number = 910;	// 是否已经领取不在冒险世界的挂机奖励
		public static PLAYER_INT_FILED_FACTION_BUILDING_SPEEDUP_DAILY_COUNT			:number = 911;	// 家族建筑升级加速每日次数
		public static PLAYER_INT_FILED_FACTION_DONATE_GIFT_EXCHANGE_DAILY_COUNT			:number = 912;	// 家族宝库贡献礼物兑换每日次数
		// ////////////////////////////////////////////////////////////////////////////////////////////////////////
		// 字符串部分
		...
		public static MAX_DIVINE_COUNT			:number = 6;
		//  升级技能类型
		...
		public static SPELL_INT_FIELD_MOUNT_SPELL_START			:number = 33;	// 进阶技能开始
		public static SPELL_INT_FIELD_MOUNT_SPELL_END			:number = 43;	// 进阶技能结束
		public static SPELL_INT_FIELD_MOUNT_BLESS_EXP			:number = 43;	// 进阶祝福值
		public static SPELL_INT_FIELD_MOUNT_ILLUSION_START			:number = 44;	// 幻化开始
		public static SPELL_INT_FIELD_MOUNT_ILLUSION_END			:number = 164;	// 幻化结束
		public static SPELL_STRENGTHEN_START			:number = 165;	// 强化开始
		public static SPELL_STRENGTHEN_END			:number = 175;	// 强化结束
		public static SPELL_STRENGTHEN_ALLMUL			:number = 176;	// 全身强化标记
		public static SPELL_GEM_START			:number = 177;	// 宝石开始
		public static SPELL_GEM_END			:number = 217;	// 宝石结束
		public static SPELL_GEM_ALLMUL			:number = 218;	// 全身宝石标记
		public static SPELL_DIVINE_COUNT			:number = 219;	// 神兵个数
		public static SPELL_DIVINE_START			:number = 220;	// 神兵开始
		public static SPELL_DIVINE_END			:number = 310;	// 神兵结束
		...
		public static MAX_FRIENT_COUNT			:number = 2;
		...
		public static SOCIAL_FRIEND_END			:number = 126;	// 好友结束
		public static SOCIAL_ENEMY_START			:number = 126;	// 仇人开始
		public static SOCIAL_ENEMY_END			:number = 166;	// 仇人结束
		public static SOCIAL_APPLY_START			:number = 166;	// 申请开始
		public static SOCIAL_APPLY_END			:number = 186;	// 申请结束
		public static SOCIAL_APPLY_CLEAR_FLAG			:number = 186;	// 申请清除标记
		public static SOCIAL_ENEMY_TIME_START			:number = 187;	// 仇人时间戳开始
		public static SOCIAL_ENEMY_TIME_END			:number = 207;	// 仇人时间戳结束
		// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// 帮派下标
		// 帮派事件
		...
		public static MAX_FACTION_INT_MEMBER			:number = 7;
		// 帮派成员的STRING信息
		...
		public static MAX_FACTION_STOREHOUSE_RECORD_COUNT			:number = 20;
		// 帮派下标
		// UINT32 部分
		...
		public static FACTION_INT_FIELD_PLAYER_END			:number = 352;	// 帮派申请索引
		public static FACTION_INT_FIELD_APPLY_PLAYER_COUNT_INDEX			:number = 352;
		public static FACTION_INT_FIELD_APPLY_PLAYER			:number = 353;	// 玩家申请加入帮派列表
		public static FACTION_INT_FIELD_APPLY_PLAYER_END			:number = 374;	// 帮派申请玩家列表
		public static FACTION_INT_FIELD_EVENT			:number = 374;	// 帮派记录开始
		public static FACTION_INT_FIELD_EVENT_END			:number = 394;	// 帮派记录结束
		public static FACTION_INT_FIELD_EVENT_FALG			:number = 394;	// 帮派记录标志位
		public static FACTION_INT_FIELD_SHOP			:number = 395;	// 商店开始
		public static FACTION_INT_FIELD_SHOP_END			:number = 403;	// 商店结束
		public static FACTION_INT_FIELD_FORCE			:number = 403;	// 帮派战斗力
		public static FACTION_INT_FIELD_MONEY			:number = 405;	// 帮派资产
		public static FACTION_INT_FIELD_LEVEL			:number = 407;	// 帮派等级
		public static FACTION_INT_FIELD_ACTIVITY			:number = 408;	// 帮派活跃度
		public static FACTION_INT_FIELD_RANK			:number = 409;	// 帮派排名
		public static FACTION_INT_FIELD_FLAGS_ID			:number = 410;	// (byte)0:帮派当前选择的旗帜ID (byte)1:神明等级 (uint16)1:灵气
		public static FACTION_INT_FIELD_MINLEV			:number = 411;	// 加入帮派最小等级
		public static FACTION_INT_FIELD_TOKEN_NUM			:number = 412;	// 令牌数量
		public static FACTION_INT_FIELD_TOKEN_POINTS			:number = 413;	// 令牌今日积分进度
		public static FACTION_INT_FIELD_TOKEN_POINTS_COUNT			:number = 414;	// 令牌今日积分完成次数
		public static FACTION_INT_FIELD_TOKEN_TODAY_BUY_COUNT			:number = 415;	// 今日令牌购买次数
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_ID_MAX			:number = 416;	// 已挑战最大boss id
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_ID			:number = 417;	// 当前挑战boss id
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_START_TIME			:number = 418;	// 当前挑战开始时间
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_HP_RATE			:number = 419;	// 当前boss血量万分比
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_POS			:number = 420;	// 当前boss位置 x,y
		public static FACTION_INT_FIELD_PROTECT_TARGET_HP_RATE			:number = 421;	// 当前守护目标血量万分比
		public static FACTION_INT_FIELD_PROTECT_TARGET_POS			:number = 422;	// 当前守护目标位置 x,y
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_START			:number = 423;	// 当前boss输出榜开始 int 输出值
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_END			:number = 473;	// 当前boss输出榜结束
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_START			:number = 473;	// 总输出榜开始
		public static FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_END			:number = 523;	// 总输出榜结束
		public static FACTION_INT_FIELD_STOREHOUSE_ITEM_COUNT			:number = 523;	// 宝库道具数量
		public static FACTION_INT_FIELD_STOREHOUSE_RECORD_CURSOR			:number = 524;	// 宝库记录游标
		public static FACTION_INT_FIELD_BUILDING_ID_START			:number = 525;	// 已有建筑id开始
		public static FACTION_INT_FIELD_BUILDING_ID_END			:number = 535;	// 已有建筑id结束
		public static FACTION_INT_FIELD_BUILDING_LVUP_ID			:number = 535;	// 当前正在升级的建筑id
		public static FACTION_INT_FIELD_BUILDING_LVUP_FINISH_TIME			:number = 536;	// 当前升级建筑完成时间戳
		...
		public static FACTION_STRING_FIELD_STOREHOUSE_RECORD_END			:number = 344;	// 宝库记录结束
		...
		public static INSTANCE_INT_FIELD_RES_START			:number = 4;	// 资源副本开始 每个信息4个byte[0:挑战次数,1:是否通关,2:预留,3:预留]
		public static INSTANCE_INT_FIELD_RES_END			:number = 9;	// 资源副本结束
		public static INSTANCE_INT_FIELD_ACTIVE_START			:number = 9;	// 活动开始
		public static INSTANCE_INT_FIELD_ACTIVE_END			:number = 59;	// 活动结束
		public static INSTANCE_INT_FIELD_ACTIVE			:number = 59;	// 活动-活跃度
		public static INSTANCE_INT_FIELD_ACTIVE_REWARD			:number = 60;	// 奖励领取状态
		public static INSTANCE_INT_FIELD_3V3_TIMES			:number = 61;	// 3v3次数 已参加次数 购买次数
		public static INSTANCE_INT_FIELD_3V3_DAY_REWARD			:number = 62;	// 3v3每日次数奖励 4个byte
		public static INSTANCE_INT_FIELD_3V3_SEGMENT_TIME			:number = 63;	// 3v3段位 发放时间
		public static INSTANCE_INT_FIELD_XIANFU_DAY_TIMES			:number = 64;	// 每日挑战次数
		public static INSTANCE_INT_FIELD_DOUJIANTAI_CURSOR			:number = 65;	// 斗剑台信息游标
		public static INSTANCE_INT_FIELD_DOUJIANTAI_ENEMY_S			:number = 66;	// 对手名次开始
		public static INSTANCE_INT_FIELD_DOUJIANTAI_ENEMY_E			:number = 69;	// 对手名次结束
		public static INSTANCE_INT_FIELD_DOUJIAN_TIMES			:number = 70;	// 斗剑次数 已挑战次数 购买次数
		public static INSTANCE_INT_FIELD_DOUJIAN_FIGHT_CD			:number = 71;	// 斗剑台挑战CD时间戳
		public static INSTANCE_INT_FIELD_DOUJIAN_FIRST_GET			:number = 72;	// 首胜奖励标记
		public static INSTANCE_INT_FIELD_DOUJIAN_FIRST_REWARD			:number = 73;	// 首胜奖励领取标记
		public static INSTANCE_INT_FIELD_DOUJIAN_COMBATWIN			:number = 74;	// 连胜纪录 纪录 当前
		public static INSTANCE_INT_FIELD_DOUJIAN_COMBATWIN_REWARD			:number = 75;	// 连胜奖励记录
		public static INSTANCE_INT_FIELD_DOUJIAN_MAX_RANK			:number = 76;	// 历史最高纪录
		...
		public static ALL_MODE			:number = 2;	// 全体模式
		public static WICKED_MODE			:number = 3;	// 恶人模式
		public static SELF_DEFENSE_MODE			:number = 4;	// 自卫模式
		public static MAX_BATTLE_MODE			:number = 5;
		// 需要发内部消息同步到场景服的技能类型
		...
		public static GLOBALVALUE_INT_FIELD_WORLD_BOSS_TIMES			:number = 285;	// 世界BOSS次数
		public static GLOBALVALUE_INT_FIELD_WORLD_BOSS_ID			:number = 286;	// 0:世界BOSS类型1, 1:世界BOSS类型2,2:当前选定的类型,3:房间个数
		public static GLOBALVALUE_INT_FIELD_XIANFU_RECORD_CURSOR			:number = 287;	// 仙府开启宝箱的记录游标
		...
		public static MAP_INT_FIELD_RESERVE3			:number = 8;	// 保留字段3
		public static MAP_INT_FIELD_RESERVE4			:number = 9;	// 保留字段4
		public static MAP_INT_FIELD_QUESTS_START			:number = 10;	// 副本任务开始
		public static MAP_INT_FIELD_QUESTS_END			:number = 34;	// 副本任务结束
		public static MAP_INT_FIELD_QUESTS_PROCESS_START			:number = 34;	// 进度开始
		public static MAP_INT_FIELD_QUESTS_PROCESS_END			:number = 37;	// 进度结束
		public static MAP_INT_FIELD_CREATE_TM			:number = 37;	// 副本创建时间
		public static MAP_INT_FIELD_START_TM			:number = 38;	// 副本开始时间
		public static MAP_INT_FIELD_QUEST_END_TM			:number = 39;	// 副本任务结束时间
		public static MAP_INT_FIELD_END_TM			:number = 40;	// 副本结束时间
		public static MAP_INT_FIELD_INSTANCE_TYPE			:number = 41;	// 副本类型
		// 地图字符串部分
		public static MAP_STR_GENERAL_ID			:number = 4;
		public static MAP_STR_REWARD			:number = 5;	// 副本奖励物品字符串
		// 小怪陆续刷
		public static REFRESH_MONSTER_FIELD_ID			:number = 45;	// 2个short(0:当前已经刷的,1:总共需要刷多少怪)
		public static REFRESH_MONSTER_FIELD_INFO_START			:number = 46;	// 怪物信息开始2个short(0:entry,1:level)
		...
		//  跨服3v3匹配
		public static KUAFU_3V3_FIELDS_INT_INFO_START			:number = 42;	//  跨服数据开始
		public static KUAFU_3V3_FIELDS_INT_INFO_END			:number = 72;	//  3v3总共6个人
		...
		//  跨服仙府夺宝匹配
		public static KUAFU_XIANFU_FIELDS_INT_INFO_START			:number = 42;	//  跨服数据开始
		public static KUAFU_XIANFU_FIELDS_INT_INFO_END			:number = 112;	//  3v3总共6个人
		public static KUAFU_XIANFU_FIELDS_INT_BOSS_INDX			:number = 112;	// 当前的bossid
		public static KUAFU_XIANFU_FIELDS_INT_BOSS_INFO_START			:number = 113;	// BOSS信息开始
		public static KUAFU_XIANFU_FIELDS_INT_BOSS_INFO_END			:number = 128;
		public static KUAFU_XIANFU_FIELDS_HARD			:number = 128;	// 副本难度
		public static XIANFU_TEST_DUMMY_COUNT			:number = 129;	// 假人数量
		...
		public static DOUJIANTAI_FIELDS_INT_RANK			:number = 42;	//  2 shorts (0:自己的排名, 1:对手的排名)
		public static DOUJIANTAI_FIELDS_INT_COMBAT_WIN_INFO			:number = 43;	//  2 shorts (0:历史最大连胜, 1:当前连胜)
		public static XIULIANCHANG_FIELDS_INT_RANK			:number = 42;	//  敌人斗剑台排行
		public static XIULIANCHANG_FIELDS_INT_ROBOT_ID			:number = 43;	//  敌人机器人序号
		public static XIULIANCHANG_FIELDS_INT_LEVEL			:number = 44;	// 敌人等级 结算经验用
		...
		// VIP BOSS
		public static VIP_INSTANCE_FIELD_ID			:number = 42;	//  0:VIP副本序号,1:副本难度
		public static WORLDBOSS_FIELDS_WAIT_TIME			:number = 42;	// 报名等待时间戳
		public static WORLDBOSS_FIELDS_BORN_TIME			:number = 43;	// 刷新等待时间戳
		// 试炼塔
		public static TRIAL_INSTANCE_FIELD_CURSOR			:number = 42;	// 当前已经刷了多少波了
		public static TRIAL_INSTANCE_FIELD_SECTION_ID			:number = 43;	// 关卡id
		public static TRIAL_INSTANCE_FIELD_ORDER			:number = 44;	// 刷怪优先级序号(1个byte存一个数据)
		public static TRIAL_INSTANCE_FIELD_BOSS_REFRESHED			:number = 45;	// 是否已经刷怪
		// 家族场景
		public static FACTION_INSTANCE_FIELD_GUID			:number = 6;	//  家族GUID string
		//  桃花迷阵最大刷新次数
		public static TAOHUA_REFRESH_TIMES			:number = 10;
		// 桃花迷阵地图数据
		public static TAOHUA_INT_FIELD_REFRESH_TIMES			:number = 42;	// 桃花迷阵已经刷新次数
		public static TAOHUA_INT_FIELD_BOSS_CURR_HP			:number = 43;	// BOSS当前血量
		public static TAOHUA_STR_FIELD_REAL_BOSS_GUID			:number = 5;	// BOSS真身GUID
		// 塔的最大层数
		public static TOWER_MAX_FLOOR			:number = 2;
		// 塔怪每层击杀数量
		public static TAGUAI_INT_FIELD_FIRST_FLOOR			:number = 42;	// 第一层的信息
		// 战斗信息整形字符型枚举
		// 貌似没必要,随便留一个吧
		...
		public static MAX_RANK_TYPE			:number = 8;
		// 特殊类型排行榜
		public static RANK_TYPE_DOUJIANTAI			:number = 9;	// 斗剑台排行
		// 单个排行榜最大排名个数
		...
		// 排行榜
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_FORCE			:number = 4;	// 战斗力
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_LEVEL			:number = 6;	// 等级
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_MONEY			:number = 7;	// 铜钱
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_ONLINE_TIME			:number = 9;	// 在线时长
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_TRIAL			:number = 10;	// 试炼塔层数
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_SHOW			:number = 11;	// 外观列表开始
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_SHOW_END			:number = 15;	// 外观结束
		public static RANK_LIST_CURRENT_OBJ_INT_FIELD_LIKE			:number = 16;	// 点赞数
		...
		// 系统模块
		public static MODULE_ROLE			:number = 101;	// 角色
		public static MODULE_BAG			:number = 102;	// 背包
		public static MODULE_QUEST			:number = 103;	// 任务
		public static MODULE_CHAT			:number = 104;	// 聊天
		public static MODULE_MAIL			:number = 105;	// 邮件
		public static MODULE_MAP			:number = 106;	// 地图
		public static MODULE_ACHIEVE			:number = 107;	// 成就
		public static MODULE_TITLE			:number = 108;	// 称号
		public static MODULE_STRENGTH			:number = 109;	// 我要变强
		public static MODULE_SPELL			:number = 201;	// 技能
		public static MODULE_DIVINE			:number = 202;	// 神兵
		public static MODULE_FASHION			:number = 203;	// 时装
		public static MODULE_PET			:number = 204;	// 宠物
		public static MODULE_MOUNT			:number = 205;	// 坐骑
		public static MODULE_MIX			:number = 206;	// 炼器
		public static MODULE_MAGIC_WEAPON			:number = 207;	// 法宝
		public static MODULE_CULTIVATION			:number = 208;	// 修炼
		public static MODULE_WING			:number = 209;	// 翅膀
		public static MODULE_MOUNT_GET			:number = 210;	// 坐骑
		public static MODULE_SOCIAL			:number = 301;	// 社交
		public static MODULE_FACTION			:number = 302;	// 家族
		public static MODULE_TEAM			:number = 303;	// 队伍
		public static MODULE_RANK			:number = 304;	// 排行榜
		public static MODULE_COUPLE			:number = 305;	// 夫妻
		public static MODULE_MASTER			:number = 306;	// 师徒
		public static MODULE_MALL			:number = 401;	// 商城
		public static MODULE_VIP			:number = 402;	// VIP特权
		public static MODULE_STALL			:number = 403;	// 摊位
		public static MODULE_AUCTION			:number = 404;	// 拍卖行
		public static MODULE_INSTANCE			:number = 501;	// 副本
		public static MODULE_ACTIVITY			:number = 502;	// 活动
		public static MODULE_ARENA			:number = 503;	// 竞技
		public static MODULE_BOSS			:number = 504;	// BOSS
		public static MODULE_PRACTICE			:number = 505;	// 修练场
		public static MODULE_DAILY_TASKS			:number = 506;	// 日常任务
		public static MODULE_WELFARE			:number = 601;	// 福利
		public static MODULE_RECHARGE_FIRST			:number = 602;	// 首充大礼
		public static MODULE_WEEK			:number = 603;	// 登陆大礼
		public static MODULE_RED_PACKET			:number = 604;	// 红包
		public static MODULE_RECHARGE			:number = 701;	// 充值返利
		public static MODULE_TOTAL_RECHARGE			:number = 702;	// 累积充值
		// 系统模块子页签
		public static MODULE_ROLE_CHAR			:number = 1;	// 角色
		public static MODULE_ROLE_SETTING			:number = 2;	// 设置
		public static MODULE_ROLE_HANG			:number = 3;	// 挂机
		public static MODULE_BAG_ATTR			:number = 1;	// 属性
		public static MODULE_BAG_ITEM			:number = 2;	// 背包
		...
		public static MODULE_QUEST_QIYU			:number = 4;	// 奇遇
		...
		public static MODULE_ACHIEVE_ALL			:number = 1;	// 成就
		public static MODULE_TITLE_ALL			:number = 1;	// 称号
		public static MODULE_STRENGTH_ALL			:number = 1;	// 我要变强
		public static MODULE_SPELL_ALL			:number = 1;	// 技能
		public static MODULE_DIVINE_ALL			:number = 1;	// 神兵
		public static MODULE_FASHION_ALL			:number = 1;	// 时装
		public static MODULE_PET_ALL			:number = 1;	// 宠物
		public static MODULE_MOUNT_UPGRADE			:number = 1;	// 进阶
		public static MODULE_MOUNT_ILLUSION			:number = 2;	// 幻化
		public static MODULE_MIX_STRENGTH			:number = 1;	// 强化
		public static MODULE_MIX_GEM			:number = 2;	// 宝石
		public static MODULE_MIX_WASH			:number = 3;	// 洗练
		public static MODULE_MAGIC_WEAPON_ALL			:number = 1;	// 法宝
		public static MODULE_CULTIVATION_ALL			:number = 1;	// 修炼
		public static MODULE_WING_ALL			:number = 1;	// 翅膀
		public static MODULE_MOUNT_GET_ALL			:number = 1;	// 获得
		...
		public static MODULE_FACTION_ACTIVITY			:number = 4;	// 家族活动
		public static MODULE_FACTION_TREASURY			:number = 5;	// 家族宝库
		public static MODULE_FACTION_SHOP			:number = 6;	// 家族商店
		public static MODULE_TEAM_ALL			:number = 1;	// 队伍
		public static MODULE_RANK_LOCAL			:number = 1;	// 本服排行
		public static MODULE_RANK_KUAFU			:number = 2;	// 跨服排行
		public static MODULE_COUPLE_ALL			:number = 1;	// 夫妻
		public static MODULE_MASTER_ALL			:number = 1;	// 师徒
		...
		public static MODULE_STALL_ALL			:number = 1;	// 摊位
		public static MODULE_AUCTION_ALL			:number = 1;	// 拍卖行
		...
		public static MODULE_INSTANCE_VIP			:number = 4;	// VIP副本
		public static MODULE_INSTANCE_TEAM			:number = 5;	// 多人副本
		public static MODULE_ACTIVITY_DAILY			:number = 1;	// 每日活动
		...
		public static MODULE_ARENA_5V5			:number = 4;	// 5V5
		public static MODULE_ARENA_10V10			:number = 5;	// 10V10
		public static MODULE_ARENA_CONTEST			:number = 6;	// 比武大会
		public static MODULE_BOSS_FIELD_BOSS			:number = 1;	// 野外BOSS
		public static MODULE_BOSS_WORLD_BOSS			:number = 2;	// 世界BOSS
		public static MODULE_PRACTICE_EXP			:number = 1;	// 修炼
		public static MODULE_PRACTICE_ATTACK			:number = 2;	// 掠夺
		public static MODULE_DAILY_TASKS_ALL			:number = 1;	// 日常任务
		public static MODULE_WELFARE_FIRST			:number = 1;	// 每日礼包
		public static MODULE_WELFARE_SIGN			:number = 2;	// 每日签到
		public static MODULE_WELFARE_ONLINE			:number = 3;	// 在线礼包
		public static MODULE_WELFARE_RANK			:number = 4;	// 等级有礼
		public static MODULE_WELFARE_BACK			:number = 5;	// 奖励找回
		public static MODULE_RECHARGE_FIRST_ALL			:number = 1;	// 首充大礼
		public static MODULE_WEEK_ALL			:number = 1;	// 七天登陆
		public static MODULE_RED_PACKET_FACTION			:number = 1;	// 家族红包
		public static MODULE_RED_PACKET_WORLD			:number = 2;	// 世界红包
		public static MODULE_RECHARGE_ALL			:number = 1;	// 充值返利
		public static MODULE_TOTAL_RECHARGE_ALL			:number = 1;	// 累积充值
	}
