...
{				
	 ...
	 * 死亡者名字
	 */
	public deathname :string ;	//String		
	/**
	 * 杀人者名字
	 */
...
class s2c_world_boss_rank
{				
	public optcode:number = 0;
	public static param_count:number = 2;
	public static optname:string = "onWorld_boss_rank"; 
	private static input:ByteArray;		
	...
	/**
	 从输入二进制流中读取结构体
	 */
	public static read(self:s2c_world_boss_rank, bytes:ByteArray):void
	{		
		if(this.input == null) 
			this.input = new ByteArray();							
		this.input =  bytes;
...
class s2c_kuafu_xianfu_match_wait
{				
	public optcode:number = 0;
	public static param_count:number = 2;
	public static optname:string = "onKuafu_xianfu_match_wait"; 
	private static input:ByteArray;		
	...
	/**
	 从输入二进制流中读取结构体
	 */
	public static read(self:s2c_kuafu_xianfu_match_wait, bytes:ByteArray):void
	{		
		if(this.input == null) 
			this.input = new ByteArray();							
		this.input =  bytes;
