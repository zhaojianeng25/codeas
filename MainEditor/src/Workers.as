...
package 
{
	...
	public class Workers
	{
		...
		[Embed(source="../workerswfs/workSave/WorkSaveFileModel.swf", mimeType="application/octet-stream")]
		private static var workSave_WorkSaveFileModel_ByteClass:Class;
		public static function get workSave_WorkSaveFileModel():ByteArray
		{
			return new workSave_WorkSaveFileModel_ByteClass();
		}
