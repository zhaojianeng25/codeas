package xyz.draw
{
	...
	public class TooMultipleLineTri3DSprite extends TooLineTri3DSprite
	{
	
		public function TooMultipleLineTri3DSprite($context3D:Context3D)
		{
			super($context3D);
		
		}
		private var _objDataItem:Vector.<TooObjData>;
		private function clearData():void
		{
			if(_objDataItem){
				for each(var $tempObjData:TooObjData in _objDataItem){
					$tempObjData.dispose();
				}
			}
			_objDataItem=new Vector.<TooObjData>;
		}
		...
		private function upToGpuMul($tempObjData:TooObjData):void
		{
		...
		protected function setVaMul($temp:TooObjData) : void {
