package mvc.left.panelleft
{
	...
	public class PanelLeftPanel extends BasePanel
	{
		...
		public function set selectRectInfoItem(value:Vector.<PanelRectInfoNode>):void
		{
		...
		protected function panelInfoTreeClik(event:ListEvent):void
		{
			if(event.itemRenderer){
			 	var $PanelRectInfoNode:PanelRectInfoNode=event.itemRenderer.data as PanelRectInfoNode	;
