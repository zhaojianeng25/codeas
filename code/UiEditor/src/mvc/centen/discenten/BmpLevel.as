package mvc.centen.discenten
{
	...
	public class BmpLevel extends UIComponent
	{
		...
		public function setBmpItem($fileDataVo:FileDataVo):void
		{

			clearDele()
			if($fileDataVo){
				_picBmp.bitmapData=$fileDataVo.bmp;
				bmpRect=new Rectangle(0,0,_picBmp.bitmapData.width,_picBmp.bitmapData.height)
			}
			drawColorSprite()
		...
		private function clearDele():void
		{
