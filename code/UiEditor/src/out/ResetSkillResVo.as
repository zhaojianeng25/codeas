package out
{
	...
	public class ResetSkillResVo extends ResetResVo
	{
		public function ResetSkillResVo($byte:ByteArray)
		{
			super($byte);
		...
		public static function chuangeFileByFile($file:File ):void
		{
			...
			var $ResetSkillRes:ResetSkillResVo=new ResetSkillResVo(_byte);
			$ResetSkillRes.read();
			$ResetSkillRes.read();
			$ResetSkillRes.read();
			$ResetSkillRes.saveFile($file)
		...
		public static  function oneByOne():void
		{
			...
			if(ResetResVo.outFileItem.length){
				...
				ResetSkillResVo.chuangeFileByFile(temp)
