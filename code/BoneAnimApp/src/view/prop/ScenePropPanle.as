package view.prop
{
	...
	public class ScenePropPanle extends BaseReflectionView
	{
		...
		if(SceneLevel.ClearColor){
			return MathCore.argbToHex(0xff,SceneLevel.ClearColor.x,SceneLevel.ClearColor.y,SceneLevel.ClearColor.z)
		}
		...
		public function setClearColor(value:int):void{
			 ...
			 SceneLevel.ClearColor=MathCore.hexToArgb(value)
		...
		private function pan3dMenu():Array
		{
			var ary:Array =
				[
					...
					{Type:ReflectionData.ColorPick,Label:"设置背景颜色:",GetFun:getClearColor,SetFun:setClearColor,Category:"环境"},
