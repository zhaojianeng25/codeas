package _Pan3D.utils.editorutils
{
	...
	public class Display3DEditorMovie extends Display3DBindMovie
	{
		...
		public function setLineVc(meshData:MeshData):void{
			...
			for(var i:int = 0;i<boneIDary.length;i++){ 
				_context.setProgramConstantsFromMatrix(Context3DProgramType.VERTEX, 28+i*4,  ary[boneIDary[i]].matrix, true);
			}
		}
		...
		override protected function setMeshVa(meshData:MeshData):void{
			...
			_context.setVertexBufferAt(1,meshData.uvBuffer, 0, Context3DVertexBufferFormat.FLOAT_2);
