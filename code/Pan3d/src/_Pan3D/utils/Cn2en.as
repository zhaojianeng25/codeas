...
{ 
	...
	public class Cn2en 
	{ 
		public function Cn2en() 
		{ 
			throw new Error("cuplayer.com单例..."); 
		} 
		 ...
		 * 
		 */
		public static function toPinyin(str:String, abbreviative:Boolean=false, addSpace:Boolean=false, filterOther:Boolean=false):String{
			if (str && str!=null && str!="") {
				var result:String = "";
				var pStr:String;
