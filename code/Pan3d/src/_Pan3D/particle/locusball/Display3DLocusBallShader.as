package _Pan3D.particle.locusball
{
	...
	public class Display3DLocusBallShader extends Shader3D
	{
		public static var DISPLAY3DLOCUSBALLSHADER:String = "Display3DLocusBallShader";

		public function Display3DLocusBallShader()
		{
			vertex = 
...
//				"mov vt0.y,vt2.z";
			...
			if(paramAry){
				if(paramAry[2] == 1){
					...
					str = baseStr + LN + LN + watchEyeStr + LN + basePosStr + LN + posStr + LN + resultPos + LN + mvpStr + LN + uvStr;
				}
