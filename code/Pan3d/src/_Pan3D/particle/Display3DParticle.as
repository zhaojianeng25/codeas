...
//		protected var _baseMatrix:Matrix3D;
		...
		override public function updateMatrix():void{
			...
			if(!isNaN(_eyeDistance)&&_eyeDistance!=0){
				var $eyeNrm:Vector3D=Scene_data.cam3D.subtract(modelMatrix.position);
				$eyeNrm.normalize();
				$eyeNrm.scaleBy(_eyeDistance);
				modelMatrix.appendTranslation($eyeNrm.x,$eyeNrm.y,$eyeNrm.z);
			}
