...
package gs.data {
	import gs.TweenLite;
	import gs.TweenMax;
	import gs.motionPaths.MotionPath;
...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		 ...
		 * 		import gs.data.TweenMaxVars; <br /><br />
		 * 
		 ...
		 * <code>
		 * 		import gs.TweenMax; <br />
		 * 		import gs.data.TweenMaxVars; <br />
		 * 		import gs.plugins.~~; <br />
		 * 		import gs.motionPaths.~~<br />
		 ...
		 * <code>
		 * 		import gs.TweenMax; <br />
		 * 		import gs.TweenMaxVars; <br />
		 * 		import gs.plugins.TweenPlugin; <br />
		 * 		import gs.plugins.Physics2DPlugin; <br />
		 ...
		 * 		import gs.data.TweenMaxVars; <br />
		 * 		import gs.plugins.TweenPlugin; <br />
		 * 		import gs.plugins.PhysicsPropsPlugin; <br />
		 ...
		 * 		import gs.data.TweenMaxVars; <br />
		 * 		import gs.plugins.TweenPlugin; <br />
		 * 		import gs.plugins.StageQualityPlugin; <br />
		...
		**/
		 ...
		 * 		import gs.data.TweenMaxVars; <br />
		 * 		import gs.plugins.TweenPlugin; <br />
		 * 		import gs.plugins.TransformAroundCenterPlugin; <br />
		 ...
		 * 		import gs.data.TweenMaxVars; <br />
		 * 		import gs.plugins.TweenPlugin; <br />
		 * 		import gs.plugins.TransformAroundPointPlugin; <br />
