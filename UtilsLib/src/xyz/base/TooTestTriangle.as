package  xyz.base
{
	...
	public class TooTestTriangle
	{
		public var p1:Point;
		public var p2:Point;
		public var p3:Point;

		public function TooTestTriangle( $p1:Point=null, $p2:Point=null, $p3:Point=null ):void
		{
			p1 = $p1;
			p2 = $p2;
			p3 = $p3;
		...
		public function checkPointIn( tp:Point ):Boolean
		{
			...
			return targetThreeTimesArea == area || Math.abs( targetThreeTimesArea - area ) < 0.1;
		}
