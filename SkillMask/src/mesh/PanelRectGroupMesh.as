package mesh
{
	...
	public class PanelRectGroupMesh extends EventDispatcher implements ITile
	{
		...
		private var _selectItem:Vector.<PanelSkillMaskNode>
		...
		public function set outPutData(value:Boolean):void
		{
			...
			for(var i:uint=0;i<_selectItem.length;i++){
				var $PanelRectInfoNode:PanelSkillMaskNode=PanelSkillMaskNode(_selectItem[i]);
		...
		public function get selectItem():Vector.<PanelSkillMaskNode>
		{
			return _selectItem;
		}
		
		public function set selectItem(value:Vector.<PanelSkillMaskNode>):void
		{
			_selectItem = value;
		}
