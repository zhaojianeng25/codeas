package _Pan3D.base
{
	...
	public class ObjectHitBox extends Object3D
	{
		...
		public function scaleClone(scale_x:Number, scale_y:Number, scale_z:Number):ObjectHitBox
		{
			var ret:ObjectHitBox = new ObjectHitBox();
