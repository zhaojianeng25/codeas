package _Pan3D.batch.particle.facet
{
	...
	public class BatchFacetParticle extends BatchParticle
	{
		private var _particleList:Vector.<IBatch>;
		
		public function BatchFacetParticle()
		{
			super();
		...
		override public function add(particle:Display3DParticle):void{
			_program = Program3DManager.getInstance().getProgram(BatchFacetShader.BATCH_FACET_SHADER);
