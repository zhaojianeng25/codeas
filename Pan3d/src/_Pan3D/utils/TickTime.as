package _Pan3D.utils
{
	...
	public class TickTime
	{
		...
		private static const _time:Timer = new Timer(100);
		//回调字典
...
//			_preTime = _nowTime;
		...
		private static function addFrame():void{
			_time.addEventListener(TimerEvent.TIMER,onTick);
			_time.start();
		}
		
		private static function removeFrame():void{
			_time.removeEventListener(TimerEvent.TIMER,onTick);
			_time.stop();
		}
