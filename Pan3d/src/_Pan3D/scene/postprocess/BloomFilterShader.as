package _Pan3D.scene.postprocess
{
	...
	public class BloomFilterShader extends Shader3D
	{
		public static var BLOOM_FILTER_SHADER:String = "BloomFilterShader";
		public function BloomFilterShader()
		{
			vertex = 
				"mov op, va0 \n"+
				"mov v1, va1";
		...
		private function getUv(key:int):String{
			...
			return perStr + "ft2.x,ft2.x," + nextStr + "\n";
		}
